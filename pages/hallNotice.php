    ...
    <main>
        <div class="container">          
            ...
            <div class="row mt-5 wow fadeIn" data-wow-delay="0.4s">
                ...
                <div class="col-lg-5">
                    <a href="#!">
                        <h3 class="post-title font-bold">Hall week celebration - Activities outline</h3>
                    </a>
                    <p class="my-4 ">
            ...
            <div class="row mt-5 wow fadeIn" data-wow-delay="0.4s">
                ...
                <div class="col-lg-5">
                    <a href="#!">
                        <h3 class="post-title font-bold">Final years dinner</h3>
                    </a>
                    <p class="my-4 ">
                        KNUST is located in Kumasi, the Garden City, in the Ashanti Region of Ghana. For persons within and around the Kumasi Metropolis, the first access point to Ghana's No.1 University is Tech. Junction, a major station just outside the main gate of the University... 
                    </p>
            ...
            <div class="row mt-4 wow fadeIn" data-wow-delay="0.3s" style="margin-top:;">
                ...
                <div class="col-lg-5">
                    <a href="" style="" data-toggle="modal" data-target="#readMore"> Read more from the University hall ...</a>
                </div>
            </div>
            ...
            <div class="row mt-4 wow fadeIn" data-wow-delay="0.3s" style="margin-top:;">
                <div class="col-lg-7"></div> 
                <div class="col-lg-5">
                    <a href="" style="" data-toggle="modal" data-target="#readMore"> Read more from Independence hall ...</a>
                </div>
            </div>
            <!-- <hr class="extra-margin my-5"> -->
            <!-- second item ends  -->
            ...
            <div class="row mt-4 wow fadeIn" data-wow-delay="0.3s" style="margin-top:;">
                <div class="col-lg-7"></div> 
                <div class="col-lg-5">
                    <a href="" style="" data-toggle="modal" data-target="#readMore">Read more from Republic hall ...</a>
                </div>
            </div>
           <!--  <hr class="extra-margin my-5"> -->
            ...
            <div class="row mt-4 wow fadeIn" data-wow-delay="0.3s" style="margin-top:;">
                <div class="col-lg-7"></div> 
                <div class="col-lg-5">
                    <a href="" style="" data-toggle="modal" data-target="#readMore"> Read more from Queens hall ...</a>
                </div>
            </div>
            ...
            <div class="row mt-4 wow fadeIn" data-wow-delay="0.3s" style="margin-top:;">
                <div class="col-lg-7"></div> 
                <div class="col-lg-5">
                    <a href="" style="" data-toggle="modal" data-target="#readMore"> Read more from Unity Hall...</a>
                </div>
            </div>
