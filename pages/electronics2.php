...
<head>
    ...
    <link href="css/electronics2.css" rel="stylesheet">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item ">
                                        <a class="page-link" href="electronics.php" aria-label="Previous">
                                    ...
                                    <li class="page-item active">
                                        <a class="page-link" href="electronics2.php">2
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="electronics3.php">3</a>
                                    </li>
                                    <li class="page-item ">
