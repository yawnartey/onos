                                                ...
                                                <div class="md-form btn-group">
                                                    ...
                                                    <select class="form-control" name="college" style="margin:20px 0px 0px 47px;">
                                                        <div class="form-group">
                                                            ...
                                                            <option value="CollegeofEngineering" name="College">College of Engineering</option>
                                                            <option value="CollegeofScience" name="College">College of Science</option>
                                                            <option value="CollegeofHealthScience" name="College">College of Health Science</option>
                                                        </div>
                                                    </select>   
                                                </div>
                                                <div class="md-form">
