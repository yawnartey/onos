        ...
        <!-- <div class="container"> -->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item" id="firstNavContent">
                        <a class="nav-link" href="timeTable.phps" id="solutionsNavText">Time table</a>
                    </li>
	            			...
	            			<div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
	            				...
	            				<div class="carousel-inner" role="listbox">
	            					...
	            					<div class="carousel-item active">
                                        <img src="img/img (36).jpg" alt="First slide" class="img-fluid rounded">
                                    ...
                                    <div class="carousel-item">
                                        <img src="img/img (107).jpg" alt="Second slide" class="img-fluid rounded">
                                        <div class="carousel-caption">
                                            <h3 class="font-bold red-text">
                    ...
                    <div class="row">
                     	...
                     	<div class="col-lg-4">
                     		...
                     		<div class="card mb-r wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <div class="card-body">
                                    <!--Title-->
                                    <h5 class="font-bold">
                                        <strong>Sony Phone Xperia</strong>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-r wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <!--Card image-->
                                <center>
                                    <img class="img-fluid " src="img/img (39).jpg" alt="Card image cap" style="">
                                </center>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-r wow fadeIn" data-wow-delay="0.6s">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="img/img (4).jpg" alt="Card image cap">
                    ...
                    <div class="row">
                     	...
                     	<div class="col-lg-4">
                     		...
                     		<div class="card mb-r wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="img/shoes (2).jpg" alt="Card image cap">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-r wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <!--Card image-->
                                <center>
                                    <img class="img-fluid " src="img/shoes (3).jpg" alt="Card image cap" style="">
                                </center>
                    ...
                    <div class="row">
                     	...
                     	<div class="col-lg-4">
                     		...
                     		<div class="card mb-r wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="img/shoes.jpg" alt="Card image cap">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-r wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <!--Card image-->
                                <center>
                                    <img class="img-fluid " src="img/sweater.jpg" alt="Card image cap" style="">
                                </center>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-r wow fadeIn" data-wow-delay="0.6s">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="img/tie.jpg" alt="Card image cap">
                    ...
                    <div class="row">
                     	...
                     	<div class="col-lg-4">
                     		...
                     		<div class="card mb-r wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="img/belt.jpg" alt="Card image cap">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-r wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <!--Card image-->
                                <center>
                                    <img class="img-fluid " src="img/glasses.png" alt="Card image cap" style="">
                                </center>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card mb-r wow fadeIn" data-wow-delay="0.6s">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="img/img (1).jpg" alt="Card image cap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item ">
                                        <a class="page-link" href="mensWatches.php" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="mensWatches.php">1</a>
                                    </li>
                                    <li class="page-item active">
                                        <a class="page-link" href="mensWatches2.php">2
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item disabled">
                                        <a class="page-link" href="mensWatches2.php" aria-label="Next">
				...
				<div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s" style="margin-top: 1.8%;">
				    <div class="widget-wrapper" style="margin-top: 8%;">
				        ...
				        <div class="list-group">
				        	<!-- <a href="ads.php" class="list-group-item">Categories:</a> -->
				        	<a href="wears.php" class="list-group-item">
				        		<h4 class="h4-responsive font-bold mb-2">Wears:</h4>
				        	</a>
				            <a href="ladiesWears.php" class="list-group-item">Ladies Wears</a>
				            <a href="ladiesShoes.php" class="list-group-item">Ladies Shoes</a>
				            <a href="gentsWears.php" class="list-group-item ">Gents Wears</a>
				            <a href="mensWatches.php" class="list-group-item active">Men's watches</a>
                            <a href="mensShoes.php" class="list-group-item">Men's shoes</a>
				            <a href="ads.php" class="list-group-item">Back to categories</a>
				        </div>
				    </div>
