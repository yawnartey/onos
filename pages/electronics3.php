...
<head>
    ...
    <title>ONos - Electronic appliances</title>
    <link rel="stylesheet" href="font-awesome-4.7.0/css/font-awesome.min.css">
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link href="css/mdb.min.css" rel="stylesheet">
    <link href="css/ads.css" rel="stylesheet">
    <link href="css/electronics3.css" rel="stylesheet">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item" id="firstNavContent">
                        <a class="nav-link" href="dos" id="navHomeText">DOS
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item ">
                                        <a class="page-link" href="electronics2.php" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="electronics.php">1</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="electronics2.php">2</a>
                                    </li>
                                    <li class="page-item active">
                                        <a class="page-link" href="electronics3.php">3
                                             <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item disabled">
                                        <a class="page-link" href="electronics3.php" aria-label="Next">
				...
				<div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s" style="margin-top: 1.8%;">
				    <div class="widget-wrapper" style="margin-top: 8%;">
				        ...
				        <div class="list-group">
				        	...
				        	<a href="electronics.php" class="list-group-item active">
				        		<h4 class="h4-responsive font-bold mb-2">Electronics:</h4>
				        	</a>
				            <a href="smartphones.php" class="list-group-item">Smartphones</a>
				            <a href="laptops.php" class="list-group-item">Laptops</a>
				            <a href="digitalCameras.php" class="list-group-item">Digital cameras</a>
