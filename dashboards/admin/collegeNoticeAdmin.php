...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
        ...
        <div class="modal fade" id="collegeNotice" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="collegeNotice_form" method="POST" enctype="multipart/form-data">
                            <p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add').click(function(){
                $('#collegeNotice').modal('show'); 
                $('#collegeNotice_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Insert"); 
            }); 
            $("#collegeNotice_form").submit(function(event){
