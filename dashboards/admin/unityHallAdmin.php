...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                       <i class="fa fa-building fa-fw"></i> Unity Hall
                    </h1> 
                </div>
            </div>
        ...
        <!-- Modal for unity  hall starts here -->
         <div class="modal fade" id="unityHall" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="unityHall_form" method="POST" enctype="multipart/form-data">
                            <p>
        ...
        <!-- Modal for unity hall ends here  -->
            ...
            function fetch_data(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        $('#unityHall_data').html(data); 
                    }
                })
            }

            $('#add').click(function(){
                $('#unityHall').modal('show'); 
                $('#unityHall_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#unityHall_form").submit(function(event){
