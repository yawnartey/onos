...
<body>
    ...
    <div id="wrapper">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-road fa-fw"></i> Republic Hall
                    </h1> 
                </div>
            </div>
        ...
        <!-- Modal for independence hall starts here -->
         <div class="modal fade" id="repuHall" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="repuHall_form" method="POST" enctype="multipart/form-data">
                            <p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add').click(function(){
                $('#repuHall').modal('show'); 
                $('#repuHall_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#repuHall_form").submit(function(event){
