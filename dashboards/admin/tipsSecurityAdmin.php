...
<body>
	...
	<div id="wrapper" class="sidebar_style">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                       <i class="fa fa-unlock-alt fa-fw"></i> Security tips
                    </h1> 
                </div>
            </div>
                ...
                <div class="col-lg-12" style="">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <span id="tipsSecurity_data"></span>
                        </div>
                    </div>
                </div>   
            </div>
        ...
        <!-- Modal for security tips starts here -->
        <div class="modal fade" id="tipsSecurity" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="tipsSecurity_form" method="POST" enctype="multipart/form-data">
                            <p>
        ...
        <!-- Modal for security tips ends here  -->
    </div>
	...
	<script>
	    $(document).ready(function() {
            ...
            function fetch_data(){
                var action = "fetch";
                $.ajax({
                    url:"tipsSecurity.php", 
                    method:"POST", 
                    data:{action:action}, 
                    success:function(data){
                        $('#tipsSecurity_data').html(data); 
            ...
            $('#add').click(function(){
                $('#tipsSecurity').modal('show'); 
                $('#tipsSecurity_form')[0].reset(); 
                $('.modal-title').text("Add Event"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#tipsSecurity_form").submit(function(event){
