<?php 
	if(isset($_POST["action"])){
		...
		if($_POST["action"] == "fetch"){
			$query = "SELECT * FROM eventssocial ORDER BY id DESC";
				...
				<div class="media wow fadeIn data-wow-delay="0.8">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<span style="font-size:16px;" id=""> '.substr($truncate, 0, 350).' 
		...
		if($_POST["action"] == "insert"){
			...
			$query = "INSERT INTO eventssocial(image, image_title, post_title, post_content) VALUES ('$file', '$image_title', '$post_title', '$post_content')"; 
		...
		if($_POST["action"] == "update"){
			...
			$post_title = $_POST["post_title"];
			$post_content = $_POST["post_content"];
			$query = "UPDATE eventssocial SET image='$file', image_title='$image_title', post_title='$post_title', post_content='$post_content' WHERE id='".$_POST["image_id"]."' "; 
			if(mysqli_query($connect, $query)){
		...
		if($_POST["action"]=="delete"){
			$query = "DELETE FROM eventssocial WHERE id='".$_POST["image_id"]."' "; 
			if(mysqli_query($connect, $query)){
