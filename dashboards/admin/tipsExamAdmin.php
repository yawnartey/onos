...
<body>
	...
	<div id="wrapper" class="sidebar_style">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-book fa-fw"></i>Exams Regulations
                    </h1> 
                </div>
            </div>
        ...
        <!-- Modal for exam guide start here -->
        <div class="modal fade" id="tipsExam" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="tipsExam_form" method="POST" enctype="multipart/form-data">
                            <p>
        ...
        <!-- Modal for exam guide ends here  -->
	...
	<script>
	    $(document).ready(function() {
            ...
            $('#add').click(function(){
                $('#tipsExam').modal('show'); 
                $('#tipsExam_form')[0].reset(); 
                $('.modal-title').text("Add Regulation"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#tipsExam_form").submit(function(event){
            ...
            $(document).on('click', '.update', function(){
                ...
                $('#action').val("update"); 
                $('.modal-title').text("Update Regulation"); 
                $('#image_title').val();
                $('#post_title').val();
                $('#post_content').val();
                $('#insert').val("Update");
