...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                       <i class="fa fa-flask fa-fw"></i> Department of Optometry
                    </h1> 
                </div>
            </div>
        ...
        <div class="modal fade" id="optoNotice" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="optoNotice_form" method="POST" enctype="multipart/form-data">
                            <p>
            ...
            function fetch_data(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        $('#optoNotice_data').html(data);
                    }
                })
            }

            $('#add').click(function(){
                $('#optoNotice').modal('show'); 
                $('#optoNotice_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#optoNotice_form").submit(function(event){
