		...
		if($_POST["action"] == "fetch"){
			...
			while($row = mysqli_fetch_array($result)){
				...
				<div class="media wow fadeIn data-wow-delay="0.8">
					<div class="row">
						<div class="col-md-5">
							<img src='.$row["image"].'  class="img-responsive" style="height:36%; width:100%; "/>
						...
						<div class="col-md-7">
							...
							<button type="button" name="update" class="btn btn-info updateDos" id="'.$row["id"].'" >Update</button>
							<button type="button" name="delete" class="btn btn-danger deleteDos" id="'.$row["id"].'">Remove</button>
						</div>
					</div>
				</div> <hr> <br>
