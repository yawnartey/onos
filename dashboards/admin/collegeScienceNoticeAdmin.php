...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                       <i class="fa fa-rss fa-fw"></i> College of Science
                    </h1> 
                </div>
            </div>
                ...
                <div class="col-lg-12" style="">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <span id="collegeScience_data"></span>
                        </div>
                    </div>
                </div>   
            </div>
        ...
        <!-- Modal for college science notice start here -->
        <div class="modal fade" id="collegeScience" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="collegeScience_form" method="POST" enctype="multipart/form-data">
                            <p>
        ...
        <!-- Modal for college of science ends here  -->
    </div>
        ...
        $(document).ready(function() {
           ...
           // events
            ...
            function fetch_data(){
                var action = "fetch";
                $.ajax({
                    url:"collegeScience.php", 
                    method:"POST", 
                    data:{action:action}, 
                    success:function(data){
                        $('#collegeScience_data').html(data);
                    }
                })
            }

            $('#add').click(function(){
                $('#collegeScience').modal('show'); 
                $('#collegeScience_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#collegeScience_form").submit(function(event){
