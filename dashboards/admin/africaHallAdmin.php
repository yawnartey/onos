...
<body>
    ...
    <div id="wrapper">
        <div id="page-wrapper" class="sidebar_style">
            <!-- username display -->
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-home fa-fw"></i> Africa Hall
                    </h1> 
                </div>
            </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" name="add" id="add">
                                        Post notice
        ...
        <!-- Modal for africa hall starts here -->
       <div class="modal fade" id="africaHall" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="africaHall_form" method="POST" enctype="multipart/form-data">
                            <p>
            ...
            function fetch_data(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        $('#africaHall_data').html(data); 
                    }
                })
            }

            $('#add').click(function(){
                $('#africaHall').modal('show'); 
                $('#africaHall_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#africaHall_form").submit(function(event){
