...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                       <i class="fa fa-building fa-fw"></i> University Hall
                    </h1> 
                </div>
            </div>
        ...
        <!-- Modal for kat starts here -->
        <div class="modal fade" id="katHall" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="katHall_form" method="POST" enctype="multipart/form-data">
                            <p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add').click(function(){
                $('#katHall').modal('show'); 
                $('#katHall_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#katHall_form").submit(function(event){
