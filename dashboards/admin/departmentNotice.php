<?php 
	if(isset($_POST["action"])){
		...
		if($_POST["action"] == "fetch"){
			$query = "SELECT * FROM departmentnotice ORDER BY id DESC";
				...
				<div class="media wow fadeIn data-wow-delay="0.8">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<button type="button" name="update" class="btn btn-warning update" id="'.$row["id"].'">Update</button>
			        ...
			        <div class="modal-dialog" role="document">
			            <div class="modal-content">
			                <div class="modal-body dark-text">
			                	 <center><span style="font-size:20px; font-weight:;">'.$row['post_title'].'</span ></center> <hr>
		...
		if($_POST["action"] == "insert"){
			...
			$query = "INSERT INTO departmentnotice(image, image_title, post_title, post_content) VALUES ('$file', '$image_title', '$post_title', '$post_content')"; 
		...
		if($_POST["action"] == "update"){
			...
			$post_title = $_POST["post_title"];
			$post_content = $_POST["post_content"];
			$query = "UPDATE departmentnotice SET image='$file', image_title='$image_title', post_title='$post_title', post_content='$post_content' WHERE id='".$_POST["image_id"]."' "; 
			if(mysqli_query($connect, $query)){
		...
		if($_POST["action"]=="delete"){
			$query = "DELETE FROM departmentnotice WHERE id='".$_POST["image_id"]."' "; 
			if(mysqli_query($connect, $query)){
