...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                       <i class="fa fa-stethoscope fa-fw"></i> College of Health Science
                    </h1> 
                </div>
            </div>
                ...
                <div class="col-lg-12" style="">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <span id="collegeHealthScience_data"></span>
                        </div>
                    </div>
                </div>   
            </div>
        ...
        <!-- Modal for college notice start here -->
       <div class="modal fade" id="collegeHealthScience" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="collegeHealthScience_form" method="POST" enctype="multipart/form-data">
                            <p>
        ...
        <!-- Modal for college notice  ends here  -->
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(){
                var action = "fetch";
                $.ajax({
                    url:"collegeHealthScience.php", 
                    method:"POST", 
                    data:{action:action}, 
                    success:function(data){
                        $('#collegeHealthScience_data').html(data); 
                    }
                })
            }

            $('#add').click(function(){
                $('#collegeHealthScience').modal('show'); 
                $('#collegeHealthScience_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#collegeHealthScience_form").submit(function(event){
                ...
                //     }
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                ...
                                fetch_data(); 
                                $('#collegeHealthScience_form')[0].reset(); 
                                $('#collegeHealthScience').modal('hide'); 
                            }
                        }); 
                    } 
                // }
