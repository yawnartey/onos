...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                       <i class="fa fa-desktop fa-fw"></i> Department of Computer Science
                    </h1> 
                </div>
            </div>
                ...
                <div class="col-lg-12" style="">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <span id="computerScience_data"></span>
                            <br>
        ...
        <div class="modal fade" id="computerScience" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="computerScience_form" method="POST" enctype="multipart/form-data">
                            <p>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(){
                var action = "fetch";
                $.ajax({
                    url:"computerScience.php", 
                    method:"POST", 
                    data:{action:action}, 
                    success:function(data){
                        $('#computerScience_data').html(data); 
                    }
                })
            }

            $('#add').click(function(){
                $('#computerScience').modal('show'); 
                $('#computerScience_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#computerScience_form").submit(function(event){
