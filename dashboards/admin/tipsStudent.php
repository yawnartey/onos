<?php 
	if(isset($_POST["action"])){
		...
		if($_POST["action"] == "fetch"){
			$query = "SELECT * FROM tipsstudent ORDER BY id DESC";
		...
		if($_POST["action"] == "insert"){
			...
			$query = "INSERT INTO tipsstudent(image, image_title, post_title, post_content) VALUES ('$file', '$image_title', '$post_title', '$post_content')"; 
		...
		if($_POST["action"] == "update"){
			...
			$post_title = $_POST["post_title"];
			$post_content = $_POST["post_content"];
			$query = "UPDATE tipsstudent SET image='$file', image_title='$image_title', post_title='$post_title', post_content='$post_content' WHERE id='".$_POST["image_id"]."' "; 
			if(mysqli_query($connect, $query)){
		...
		if($_POST["action"]=="delete"){
			$query = "DELETE FROM tipsstudent WHERE id='".$_POST["image_id"]."' "; 
			if(mysqli_query($connect, $query)){
