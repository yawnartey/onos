...
<body>
	...
	<div id="wrapper" class="sidebar_style">
        ...
        <!-- Modal for students guide start here -->
         <div class="modal fade" id="tipStudent" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="tipStudent_form" method="POST" enctype="multipart/form-data">
                            <p>
	...
	<script>
	    $(document).ready(function(){
            ...
            $('#add').click(function(){
                $('#tipStudent').modal('show'); 
                $('#tipStudent_form')[0].reset(); 
                $('.modal-title').text("Add Guide"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#tipStudent_form").submit(function(event){
