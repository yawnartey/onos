...
<body>
    ...
    <div id="wrapper" class="sidebar_style">
        ...
        <!-- Modal for queens hall starts here -->
        <div class="modal fade" id="queensHall" role="document" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <form id="queensHall_form" method="POST" enctype="multipart/form-data">
                            <p>
            ...
            function fetch_data(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        $('#queensHall_data').html(data); 
                    }
                })
            }

            $('#add').click(function(){
                $('#queensHall').modal('show'); 
                $('#queensHall_form')[0].reset(); 
                $('.modal-title').text("Add Notice"); 
                $('#image_id').val(''); 
                $('#action').val('insert'); 
                $('#insert').val("Send"); 
            }); 
            $("#queensHall_form").submit(function(event){
