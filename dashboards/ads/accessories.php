...
<head>
    ...
    <link href="css/laptops2.css" rel="stylesheet">
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item" id="firstNavContent">
                        <a class="nav-link" href="timetTable.php" id="solutionsNavText">Time table</a>
                    </li>
                            ...
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item disabled">
                                        <a class="page-link" href="accessories.php" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    <li class="page-item active">
                                        <a class="page-link" href="accessories.php">1
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="accessories2.php">2</a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="accessories2.php" aria-label="Next">
				...
				<div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s" style="margin-top: 1.8%;">
				    <div class="widget-wrapper" style="margin-top: 8%;">
				        ...
				        <div class="list-group">
				            ...
				            <a href="accessories.php" class="list-group-item active">
                               <h4 class="h4-responsive font-bold mb-2"> Accessories </h4>
                            </a>
                            <a href="ads.php" class="list-group-item ">Back to catgories</a>
				        </div>
				    </div>
