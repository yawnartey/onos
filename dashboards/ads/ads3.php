...
<head>
    ...
    <link href="css/ads3.css" rel="stylesheet">
	            			...
	            			<div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
	            				...
	            				<div class="carousel-inner" role="listbox">
	            					...
	            					<div class="carousel-item active">
                                        <img src="img/product1.jpg" alt="First slide" class="img-fluid rounded">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a class="page-link" href="ads2.php" aria-label="Previous">
                                    ...
                                    <li class="page-item active">
                                        <a class="page-link" href="ads3.php">3
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s" style="margin-top: 1.8%;">
                    <div class="widget-wrapper" style="margin-top: 8%;">
                        ...
                        <div class="list-group">
                            ...
                            <a href="jewellery" class="list-group-item">Jewellery</a>
