...
<head>
    ...
    <link href="css/ads2.css" rel="stylesheet">
</head>
<body>		
	<!-- navbar starts here  -->
	            			...
	            			<div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
	            				...
	            				<div class="carousel-inner" role="listbox">
	            					...
	            					<div class="carousel-item active">
                                        <img src="img/img (109).jpg" alt="First slide" class="img-fluid rounded">
                                    ...
                                    <div class="carousel-item">
                                        <img src="img/product2.jpg" alt="Second slide" class="img-fluid rounded">
                                        <div class="carousel-caption">
                                            <h3 class="font-bold red-text">
                                    ...
                                    <!--Third slide-->
                                    <div class="carousel-item">
                                        <img src="img/product4.jpg" alt="Third slide" class="img-fluid rounded">
                                        <div class="carousel-caption">
                                            <h3 class="font-bold red-text">
                    ...
                    <div class="row">
                     	...
                     	<div class="col-lg-4">
                     		...
                     		<div class="card mb-r wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <!--Card image-->
                                <img class="img-fluid" src="img/13.jpg" alt="Card image cap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a class="page-link" href="ads.php" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    <li class="page-item ">
                                        <a class="page-link" href="ads.php">1</a>
                                    </li>
                                    <li class="page-item active">
                                        <a class="page-link" href="ads2.php">2
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="ads3.php" aria-label="Next">
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s" style="margin-top: 1.8%;">
                    <div class="widget-wrapper" style="margin-top: 8%;">
                        ...
                        <div class="list-group">
                            ...
                            <a href="homeAppliances" class="list-group-item">Home appliances</a>
                        </div>
                    </div>
