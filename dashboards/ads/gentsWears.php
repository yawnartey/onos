                            ...
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item disabled">
                                        <a class="page-link" href="gentsWears.php" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    <li class="page-item active">
                                        <a class="page-link" href="gentsWears.php">1
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="gentsWears2.php">2</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="gentsWears2.php" aria-label="Next">
				...
				<div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s" style="margin-top: 1.8%;">
				    <div class="widget-wrapper" style="margin-top: 8%;">
				        ...
				        <div class="list-group">
				            ...
				            <a href="gentsWears.php" class="list-group-item active">Gents Wears</a>
