                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item ">
                                        <a class="page-link" href="homeAppliances2.php" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="homeAppliances.php">1</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="homeAppliances2.php">2</a>
                                    </li>
                                    <li class="page-item active">
                                        <a class="page-link" href="homeAppliances3.php">3
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item disabled">
                                        <a class="page-link" href="homeAppliances3.php" aria-label="Next">
