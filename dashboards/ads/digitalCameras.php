        ...
        <!-- <div class="container"> -->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item" id="firstNavContent">
                        <a class="nav-link" href="#" id="articlesNavText">Events</a>
                    </li>
                    <li class="nav-item" id="firstNavContent">
                            ...
                            <nav class="row flex-center wow fadeIn" data-wow-delay="0.2s">
                                <ul class="pagination">
                                    <li class="page-item disabled">
                                        <a class="page-link" href="digitalCameras.php" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    <li class="page-item active">
                                        <a class="page-link" href="digitalCameras.php">1
                                            <span class="sr-only">(current)</span>
                                        </a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="digitalCameras2.php">2</a>
                                    </li>
                                    <li class="page-item ">
				...
				<div class="col-lg-4 wow fadeIn" data-wow-delay="0.2s" style="margin-top: 1.8%;">
				    <div class="widget-wrapper" style="margin-top: 8%;">
				        ...
				        <div class="list-group">
				            ...
				            <a href="digitalCameras.php" class="list-group-item active">
                                <h4 class="h4-responsive font-bold mb-2">Digital cameras</h4>
                            </a>
