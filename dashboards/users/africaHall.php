            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-bell fa-fw"></i>Africa Hall
                    </h1>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       Thank you for subscribing. You will be notified daily whenever Africa Hall notice is posted
                    </div>
