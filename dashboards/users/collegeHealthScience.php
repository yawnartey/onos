                ...
                <div class="col-lg-12" style="">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <span id="collegeHealth_data"></span>
                        </div>
                    </div>
                </div>   
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       Thank you for subscribing. You will be notified daily whenever College of Health Science notice is posted
                    </div>
	...
	<script>
	    $(document).ready(function() {
            ...
            function fetch_data(){
                var action = "fetch";
                $.ajax({
                    url:"collegeHealthSci.php", 
                    method:"POST", 
                    data:{action:action}, 
                    success:function(data){
                        $('#collegeHealth_data').html(data); 
                    }
                })
            }
