            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <i class="fa fa-bell fa-fw"></i>Department of Optometry
                    </h1> 
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       Thank you for subscribing. You will be notified daily whenever Department of Optometry notice is posted
                    </div>
